...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="list_rt" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
            ...
            <form id="formAddrt">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama rt</label>
                        <input type="text" name="nama_rt" id="rt" class="form-control" required>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form id="formEditrt">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama rt</label>
                        <input type="text" name="nama_rt" id="rt1" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
