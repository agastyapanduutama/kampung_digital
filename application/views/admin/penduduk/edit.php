<form action="<?= base_url("admin/penduduk/update/". $this->req->acak($data->id)) ?>" method="POST">
    <div class="modal-body">
        <div class="form-group">
            <label>Warga</label>
            <input type="number" value="<?= $data->warga ?>" name="warga" id="" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select name="jk" class="form-control" id="">
                <option value="0" <?php if ($data->jk == '0') { echo "selected"; }?>>Perempuan</option>
        ...
        <div class="form-group">
            ...
            <select name="id_agama" class="form-control" id="">
                ...
                <?php foreach ($agama as $key) : ?>
                    <option value="<?= $key->id ?>" <?php if ($key->id == $data->id_agama) { echo "selected"; }?> ><?= $key->nama_agama ?></option>
                <?php endforeach ?>
            </select>
        </div>
        <div class="form-group">
            ...
            <select name="id_pendidikan" class="form-control" id="">
                ...
                <?php foreach ($pendidikan as $key) : ?>
                    <option value="<?= $key->id ?>" <?php if ($key->id == $data->id_pendidikan) { echo "selected"; }?> ><?= $key->nama_pendidikan ?></option>
                <?php endforeach ?>
            </select>
        </div>
        <div class="form-group">
            ...
            <select name="id_pekerjaan" class="form-control" id="">
                ...
                <?php foreach ($pekerjaan as $key) : ?>
                    <option value="<?= $key->id ?>" <?php if ($key->id == $data->id_pekerjaan) { echo "selected"; }?> ><?= $key->nama_pekerjaan ?></option>
                <?php endforeach ?>
            </select>
        </div>
        <div class="form-group">
            ...
            <select name="id_pernikahan" class="form-control" id="">
                ...
                <?php foreach ($pernikahan as $key) : ?>
                    <option value="<?= $key->id ?>" <?php if ($key->id == $data->id_pernikahan) { echo "selected"; }?> ><?= $key->nama_pernikahan ?></option>
                <?php endforeach ?>
            </select>
        </div>
        <div class="form-group">
